...
class StaticSearchPlugin {
    ...
    addSearchContent(rendererInstance, context) {
        ...
        this.globalContext = rendererInstance.globalContext;
    ...
    renderSearchFeed() {
        ...
        this.context.posts = this.rendererInstance.contentStructure.posts;
        this.context.pages = this.rendererInstance.contentStructure.pages;
